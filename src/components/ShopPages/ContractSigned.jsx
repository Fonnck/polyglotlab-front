      ...
      <Page size="letter" style={styles.page}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.tab}>
            ...
            aprendizaje del idioma, y las habilidades lingüísticas de acuerdo al
            nivel retroalimentando el proceso de enseñanza.
            <br />
        ...
        <Text style={styles.paragraph}>
          ...
          profesional, EL CONTRATISTA se reserva el derecho de realizar ajustes
          a los componentes referidos, siempre que se mantenga el espíritu del
          servicio contratado y se cumpla con el alcance acordado.
        </Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.paragraph}>
          PARÁGRAFO ÚNICO: Tener presente que la impartición de las clases va de
          la mano con los recesos correspondientes al calendario escolar
          manejado en el Colegio Carl Rogers. Recesos previstos: (Semana santa,
          receso de mitad de año de semanas de junio y julio, y receso de una
          semana en octubre). Por lo anterior, el mes de julio se cobra la mitad
          de la mensualidad y todos los meses se pagan completos.
        </Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.tab}>
          1. Cancelar el valor correspondiente al contrato tal y como se indica
          ...
          cumplimiento de este deber es requisito indispensable para el proceso
          de contratación.
        </Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.tab}>
          ...
          <br />
          3. Informar sobre cualquier situación que pueda afectar los intereses
          del CONTRATANTE.
          <br />
          4. Cuando no pueda asistir a una clase programada, deberá informar con
          24 (veinticuatro) horas de anticipación a menos que se trate de un
          caso fortuito o fuerza mayor, donde deberá dar aviso con la mayor
        ...
        <Text style={styles.paragraph}>
          ...
          asistir a otro nivel y desarrollar actividades que se abordaron con su
          grupo SEXTA. VALOR DEL CONTRATO Y FORMA DE PAGO: Como valor estimado
          del presente contrato, se ha pactado la suma de 1.a) Ciento ochenta y
          cinco mil pesos ($ 185.000) mensuales por un idioma, y una matrícula
          anual de ciento diez mil pesos ($110.000) o 1.b) doscientos ochenta y
          cinco mil pesos ($285.000) mensuales por dos idiomas y una matrícula
          anual de doscientos mil pesos (200.000) una a título de honorarios,
          valor el cual deberá ser pagado los primeros diez (10) días de cada
          mes. En el caso de Inglés primaria: Explorers a Travelers 4, los
          estudiantes renuevan el libro en Julio, y deben adquirir el nuevo
          libro del siguiente nivel en cien mil pesos (100.000)
        </Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.paragraph}>
          ...
          modalidad de transferencias indicadas por los medios de comunicación.
        </Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.tab}>
          ...
          solicitar las indemnizaciones a que haya lugar e iniciar las acciones
          legales pertinentes.
        </Text>
        <Text style={styles.paragraph}>
          OCTAVA. SUSPENSIÓN TEMPORAL DEL CONTRATO: Por circunstancias de fuerza
          mayor o caso fortuito se podrá, de común acuerdo entre LAS PARTES,
          suspender temporalmente la ejecución del CONTRATO, mediante la
          suscripción de un acta donde conste tal evento, sin que para los
          efectos del plazo extintivo se compute el tiempo de la suspensión. EL
          CONTRATANTE podrá suspender el presente contrato por causas
          justificadas, consagradas en la ley y que a su juicio hagan necesaria
          tal suspensión dando aviso al CONTRATISTA con cinco (5) días hábiles
          de anticipación, en cuyo caso, éste renuncia expresamente a reclamar
          perjuicios o indemnizaciones por tal causa.
        </Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.paragraph}>
          ...
          para la ejecución de los servicios aquí contratados; razón por la cual
          no habrá lugar a obligaciones a cargo del CONTRATANTE respecto al pago
          de salarios, prestaciones sociales ni demás derechos que amparen a
          trabajadores subordinados o dependientes. PARÁGRAFO ÚNICO: Entre LAS
          PARTES no existirá relación laboral alguna. Sin embargo, EL
          CONTRATISTA propenderá por encauzar las instrucciones sobre el
        ...
        <Text style={styles.paragraph}>
          DÉCIMA PRIMERA. RESOLUCIÓN DE CONFLICTOS: Todas las diferencias que se
          presenten entre LAS PARTES con ocasión de la ejecución del presente
          contrato o con motivo de su terminación o liquidación, serán en
          primera instancia resueltas directamente por estas. En caso de no ser
          posible su resolución, estas serán sometidas a mecanismos alternativos
          de solución de conflictos como la conciliación en un centro
          debidamente autorizado. Agotada estas etapas y de no ser posible el
          arreglo, LAS PARTES podrán acudir a la jurisdicción ordinaria.
          PARÁGRAFO ÚNICO: Esta disposición no será aplicable para las
          obligaciones que puedan ser exigidas ejecutivamente.
        </Text>
        <Text style={styles.paragraph}>
          DÉCIMA SEGUNDA. MÉRITO EJECUTIVO: El presente documento presta mérito
          ejecutivo para exigir el pago de la cláusula penal, y de cualquier
          otra suma de dinero a su cargo, resultante de incumplimientos
          contractuales, para lo cual bastará la simple afirmación hecha por la
          parte cumplida en la demanda, y que no podrá ser desvirtuada sino con
          la prueba del cumplimiento de las declaraciones contenidas en el
          presente contrato. PARÁGRAFO ÚNICO: Para efectos del presente
          contrato, la principal obligación cuyo cumplimiento podrá ser exigida
          ejecutivamente es el cobro de los acreencias causadas por la
          prestación de los servicios objeto del mismo.
        </Text>
        <Text style={styles.paragraph}>
          DÉCIMA TERCERA. CONFIDENCIALIDAD Y RESERVA DE LA INFORMACIÓN: Toda la
          información suministrada en virtud del presente contrato, es de
          ...
          terceros o a usar para propósitos distintos del desarrollo del objeto
          contractual, toda o parte de la información a que tengan acceso en la
          ejecución del presente contrato; este también se obliga a no extraer
          de las instalaciones del CONTRATISTA ningún tipo de archivo físicos o
          virtual, excepto cuando por razón de las obligaciones y
          responsabilidades del CONTRATISTA, este requiera extraer los mismos,
          en cuyo caso EL CONTRATANTE deberá obtener autorización previa y
          escrita de EL CONTRATISTA, y devolverá dicha información a las
          instalaciones del CONTRATISTA una vez las circunstancias hayan cesado.
          Por su parte, EL CONTRATISTA se compromete a hacer un uso racional y
          responsable de la información que le sea suministrada, siempre
          encaminado al cumplimiento cabal del objeto contractual. PARÁGRAFO
          ÚNICO: En caso de que un tercero, órgano administrativo o judicial
          competente, requiera la divulgación de toda o parte de la información
          a la que tenga acceso EL CONTRATANTE, deberá notificarle al
          CONTRATISTA de tal requerimiento inmediatamente hubiere tenido
          conocimiento del mismo, y en todo caso, antes del vencimiento de los
          términos previstos en el requerimiento para su respuesta. Lo mismo
          sucederá en la situación contraria.
        </Text>
        <Text style={styles.paragraph}>
          DÉCIMA CUARTA. PROTECCIÓN DE DATOS: EL CONTRATANTE declara
          expresamente que para efectos de la relación civil con EL CONTRATISTA
          suministra datos personales indispensables, opcionales y sensibles y
          que de manera expresa autoriza al CONTRATISTA el tratamiento o
          cualquier operación sobre datos personales, tales como la recolección,
          almacenamiento, uso, circulación o supresión de los datos personales
          del CONTRATANTE que se requieran o que estén relacionados con la
          Institución, con la relación civil y/o con la relación
          pos-contractual. Así mismo, EL CONTRATANTE autoriza la transferencia
          de datos a las entidades públicas o administrativas en ejercicio de
          las competencias legales o por orden judicial; EL CONTRATANTE autoriza
          al CONTRATISTA la transferencia de datos a terceros para los fines
          propios de la institución. EL CONTRATANTE declara que se le ha
          informado de manera clara y comprensible que tiene los siguientes
          derechos: a conocer, actualizar y rectificar los datos personales
          proporcionados; presentar ante la autoridad competente quejas por
          infracciones a lo dispuesto en la ley y las demás normas que la
          modifiquen, adicionen o complementen; revocar la presente autorización
          y/o solicitar la supresión del dato cuando en el tratamiento no se
          respeten los principios, derechos y garantías constitucionales y
          legales; acceder en forma gratuita a los datos personales que hayan
          sido objeto de tratamiento; solicitar prueba de la presente
          autorización, o cualquier otra que suscriba, salvo cuando expresamente
          se exceptúe como requisito para el tratamiento de datos de conformidad
          con la ley, es decir,
        </Text>
        ...
        <Text style={styles.paragraph}>
          ...
          represente sus derechos, de manera permanente e irrevocable para que,
          con fines estadísticos, de control o supervisión, procese, conserve,
          consulte, suministre o actualice cualquier información de carácter
          personal, desde el momento de la suscripción del contrato de
          prestación de servicios, en los términos y durante el tiempo que los
          sistemas de bases de datos, las normas y las autoridades lo
          establezcan. La consecuencia de esta autorización será la inclusión de
          la información de EL CONTRATISTA en las bases de datos. Lo anterior,
          para dar cumplimiento a la Ley Estatutaria 1581 de 2012 y su Decreto
          Reglamentario 1377 de 2013 “Por la cual se dictan disposiciones
          generales para la protección de datos personales”. EL CONTRATANTE
          declara que la información suministrada, ha sido entregada de forma
          voluntaria y verídica. PARÁGRAFO 2: EL CONTRATISTA no utilizará sin
          autorización previa los datos personales DEL CONTRATANTE para fines
          comerciales.
        </Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.paragraph}>
          ...
          contratado, EL CONTRATANTE necesita un nuevo servicio del CONTRATISTA,
          se deberá hacer un nuevo Contrato de Prestación de Servicios y no se
          entenderá como prorroga por desaparecer las causas contractuales que
          dieron origen a este contrato.
        </Text>
        <Text style={styles.paragraph}>
          DÉCIMA SÉPTIMA. DIRECCIÓN DE LAS PARTES: LAS PARTES constituyen los
          siguientes domicilios, donde tendrán efecto todas las notificaciones,
