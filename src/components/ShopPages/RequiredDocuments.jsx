    ...
    <div className="sidebar-widget post-widget">
      ...
      <div className="post-inner" onClick={() => setStudent(student)}>
        <div
          className={
            "post " +
            (renderFiles.includes("TI") ? "disabled_pointer" : "pointer")
          }
          onClick={() => {
            !renderFiles.includes("TI") && handleShow("Tarjeta de Identidad");
          }}
        >
          ...
          <span
            className="price"
            style={{ color: renderFiles.includes("TI") ? "green" : "red" }}
          >
        ...
        <div
          className={
            "post " +
            (renderFiles.includes("CC") ? "disabled_pointer" : "pointer")
          }
          onClick={() => {
            !renderFiles.includes("CC") && handleShow("Cédula de ciudadanía");
          }}
        >
          <figure className="post-thumb">
            <div>
          ...
          <span
            className="price"
            style={{ color: renderFiles.includes("CC") ? "green" : "red" }}
          >
        ...
        <div
          className={
            "post " +
            (renderFiles.includes("RC") ? "disabled_pointer" : "pointer")
          }
          onClick={() => {
            !renderFiles.includes("RC") && handleShow("Registro Civil");
          }}
        >
          <figure className="post-thumb">
            <div>
          ...
          <span
            className="price"
            style={{ color: renderFiles.includes("RC") ? "green" : "red" }}
          >
