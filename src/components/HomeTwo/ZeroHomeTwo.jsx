                        ...
                        <div className="row align-items-center">
                            <div className="content-column col-lg-7 col-md-6">
                                <div className="content-box">
                                    ...
                                    <h2 className="title animate-3">The best <br/>program to  <span className="style-font">enroll</span> <br/>for exchange</h2>
                                    <div className="tp-caption">
                                        <div className="text">World-class training and development programs <br className="d-none d-lg-block" />developed by top teachers</div>
                                    </div>
                                    <div className="btn-box animate-4">
                                        <Link to="/about-us" className="theme-btn btn-style-one bg-theme-color2">
