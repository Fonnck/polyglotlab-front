                            ...
                            <div className="footer-widget contact-widget">
                                ...
                                <div className="widget-content">
                                    <ul className="contact-info">
                                        ...
                                        <li><i className="fa fa-envelope"></i> <Link to="mailto:needhelp@potisen.com">needhelp@company.com</Link></li>
                                        <li><i className="fa fa-map-marker-alt"></i> 80 Broklyn Golden Street. New York. USA</li>
                                    </ul>
                                    <div className="subscribe-form">
                                        <form method="post" action="#">
                                            <div className="form-group">
                                                <input type="email" name="email" className="email" placeholder="Email Address" required />
                                                <button type="button" className="theme-btn btn-style-one"><i className="fa fa-long-arrow-alt-right"></i></button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
